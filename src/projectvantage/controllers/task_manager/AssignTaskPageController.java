...
public class AssignTaskPageController implements Initializable {
    ...
    private static AssignTaskPageController instance;
    ...
    public static AssignTaskPageController getInstance() {
        return instance;
    }
    ...
    private void assignButtonMouseClickHandler(MouseEvent event) {
        ...
        if(db.executeQuery(sql, memberId, taskId)) {
            ...
            alertConf.showAlert(Alert.AlertType.INFORMATION, "Task Successfully Assigned!", "Assign success!", currentStage);
            currentStage.close();
